...
gdf_apd = gpd.read_file('PA_APD_Seringueira_Agrupado.shp')
gdf_aud = gpd.read_file('PA_AUD_Seringueira_Agrupado.shp')
...
m = folium.Map(location=[centroid_y, centroid_x], zoom_start=12, tiles=None)
